...
def correct_policies(
    ...
    *,
    ...
    If candidates is None, this streams over the induced language.
    No materialisation of L_v is needed.
    """
    vocab = task.vocab
    if candidates is None:
        candidates = vocab.iter_language_masks()
...
def learn(
    ...
    *,
    ...
    It streams over the induced language, filters to correct policies,
    and selects a proxy-maximal one.

    Ties are broken deterministically.
    No materialisation of L_v is needed when candidates is None.
    """
    vocab = task.vocab
    if candidates is None:
        candidates = vocab.iter_language_masks()
